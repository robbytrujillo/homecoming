...
// Proses tambah pengembalian laptop
if (isset($_POST['tambah'])) {
    ...
    $stmt = $pdo->prepare("INSERT INTO pengembalian_laptop (nomor_induk, nama_siswa, kelas, tanggal_pengembalian, petugas, keterangan) 
                           VALUES (?, ?, ?, ?, ?, ?)");
            ...
            <div class="col-md-6 offset-md-3">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">Form Pengembalian Laptop</h3>
                    </div>
                    <div class="card-body">
