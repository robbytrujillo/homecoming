...
$stmt = $pdo->prepare("SELECT * FROM kedatangan WHERE nomor_induk = :nomor_induk ORDER BY tanggal_datang DESC LIMIT :offset, :batas");
$stmt->bindValue(':nomor_induk', $nomor_induk, PDO::PARAM_STR);
