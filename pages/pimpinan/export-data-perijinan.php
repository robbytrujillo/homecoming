...
<head>
    <title>Data Perijinan Siswa - Pimpinan</title>
...
<body>
    ...
    <div class="container mt-3 mb-3">
        ...
        <h4 class="mt-3 mb-3 text-center">Data Perijinan Siswa</h4>
        <br>
            ...
            <table class="table table-bordered" id="mauexport" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?= hariIndonesia($data['tanggal_pulang']); ?>,
                            <?= tanggalIndonesia($data['tanggal_pulang']); ?>
                        </td>
                        <td><?php echo date('H:i', strtotime($tanggal_pulang)); ?></td>
