...
<body>
    ...
    <div class="container mt-3 mb-3">
        ...
        <h4 class="mt-3 mb-3 text-center">Data Perijinan Laptop</h4>
        <br>
            ...
            <table class="table table-bordered" id="mauexport" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    foreach($ambilsemuadataperijinanlaptop as $data) {                                          
                        ...
                        $waktu = $data['tanggal_pengambilan'];
                    ...
                    <tr>
                        <td><?= $i++; ?></td>
                        <!-- <td><?php echo date('l, d F Y', strtotime($tanggal_pengambilan)); ?></td> -->
                        <td>
                            <?= hariIndonesia($data['tanggal_pengambilan']); ?>,
                            <?= tanggalIndonesia($data['tanggal_pengambilan']); ?>
                        </td>
                        <td><?php echo date('H:i', strtotime($tanggal_pengambilan)); ?></td>
