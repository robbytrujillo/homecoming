            ...
            <table class="table table-bordered" id="mauexport" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php 
                            ...
                            $ambilsemuadatakedatangan = $pdo->query( "SELECT * FROM kedatangan ORDER BY tanggal_datang DESC")->fetchAll();
                            $i = 1;

                            foreach($ambilsemuadatakedatangan as $data) {                                          
                                $tanggal_datang = $data['tanggal_datang'];
                                $waktu = $data['tanggal_datang'];
                    ...
                    <tr>
                        <td><?= $i++; ?></td>
                        <!-- <td><?php echo date('d F Y', strtotime($tanggal_datang)); ?></td> -->
                        <td>
                            <?= hariIndonesia($data['tanggal_datang']); ?>,
                            <?= tanggalIndonesia($data['tanggal_datang']); ?>
                        </td>
                        <td><?php echo date('H:i', strtotime($tanggal_datang)); ?></td>
