...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light container sticky-top"><img
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a style="color: #28A745;" class="nav-link" href="data-petugas.php"><b>Data
                            Petugas</b></a></li>
    ...
    <div class="container mt-3 mb-3">
        ...
        <div>
            < !-- <button class="btn btn-primary rounded-pill" data-toggle="modal" data-target="#tambahPetugasModal">
                Tambah Petugas</button><button class="btn btn-success rounded-pill" data-toggle="modal"
                    ...
                    class="btn btn-success rounded-pill">Kembali</a><a href="export-petugas.php"
                    class="btn btn-info rounded-pill">Print</a>
        </div>
        < !-- Modal Upload CSV -->
                        ...
                        <div class="modal-body">
                            <form action="upload_csv_petugas.php" method="POST" enctype="multipart/form-data">
                                ...
                                < !-- <div class="form-group"><input type="text" id="searchInput" class="form-control"
                                        placeholder="Cari berdasarkan NIP, Nama Petugas, Jabatan, atau Mapel...">
                        </div>--></form>
                    </div>
                </div>
            </div>
    ...
    foreach ($petugas as $row): ?><tr>
                        < !-- <td><?php echo $key+1;
    ?></td>-->< !-- <td><?php echo $row['nip'];
    ?></td>
                                <td><?php echo $row['nama_petugas'];
    ?></td>
    ...
    ?></td>--><td><?=$nomor++;
    ?></td>
                                <td><?=htmlspecialchars($row['nip']);
    ?></td>
                                <td><?=htmlspecialchars($row['nama_petugas']);
    ?></td>
                                <td><?=htmlspecialchars($row['jabatan']);
    ?></td>
                                <td><?=htmlspecialchars($row['mapel']);
    ?></td>
                    ...
                    < !-- Modal Edit Petugas -->
                        <div class="modal fade" id="editPetugasModal<?php echo $row['id']; ?>" tabindex="-1"
                            aria-labelledby="editPetugasModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editPetugasModalLabel">Edit Petugas</h5><button
                                            type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                                aria-hidden="true">&times;
                                            </span></button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="" method="POST"><input type="hidden" name="id"
                                            ...
                                            <div class="form-group"><label for="nip">NIP</label><input type="text"
                                                    ...
                                                    value="<?php echo $row['nip']; ?>" required></div>
                                            <div class="form-group"><label for="nama_petugas">Nama Petugas</label><input
                                                    type="text" class="form-control" id="nama_petugas"
                                                    name="nama_petugas" value="<?php echo $row['nama_petugas']; ?>"
                                                    required></div>
                                            <div class="form-group"><label for="jabatan">Jabatan</label><input
                                                    type="text" class="form-control" id="jabatan" name="jabatan"
                                                    value="<?php echo $row['jabatan']; ?>" required></div>
                                            <div class="form-group"><label for="mapel">Mata Pelajaran</label><input
                                                    type="text" class="form-control" id="mapel" name="mapel"
                                                    value="<?php echo $row['mapel']; ?>" required></div><button
