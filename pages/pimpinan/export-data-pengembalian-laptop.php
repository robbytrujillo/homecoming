...
<head>
    <title>Data Pengembalian Laptop - Pimpinan</title>
        ...
        <div class="data-tables datatable-dark">
            ...
            <table class="table table-bordered" id="mauexport" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    $ambilsemuadatapengembalianlaptop = $pdo->query( "SELECT * FROM pengembalian_laptop ORDER BY tanggal_pengembalian DESC")->fetchAll();
                    $i = 1;
                    ...
                    <tr>
                        <td><?= $i++; ?></td>
                        <td>
                            <?= hariIndonesia($data['tanggal_pengembalian']); ?>,
                            <?= tanggalIndonesia($data['tanggal_pengembalian']); ?>
                        </td>
