...
<body>
    ...
    <div class="container mt-3 mb-3">
        ...
        <div>
            <button class="btn btn-primary rounded-pill" data-toggle="modal" data-target="#tambahUsersModal">Tambah
                Users</button>
        ...
        <table class="table table-bordered" id="dataTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-warning btn-sm rounded-pill" data-toggle="modal"
                            data-target="#editUsersModal<?php echo $row['id']; ?>">Edit</button>
                        <a href="data-users.php?hapus=<?php echo $row['id']; ?>"
                ...
                <!-- Modal Edit Users -->
                <div class="modal fade" id="editUsersModal<?php echo $row['id']; ?>" tabindex="-1"
                    aria-labelledby="editUsersModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
    ...
    <div class="modal fade" id="tambahUsersModal" tabindex="-1" aria-labelledby="tambahUsersModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
